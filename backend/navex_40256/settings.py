"""
Django settings for navex_40256 project.
...
WSGI_APPLICATION = 'navex_40256.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "navex_40256 API",
    "DESCRIPTION": "API documentation for navex_40256 App",
    "VERSION": "v1",
}
